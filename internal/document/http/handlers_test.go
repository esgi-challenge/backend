...
func TestCreate(t *testing.T) {
	...
	handlers := NewDocumentHandlers(nil, mockUseCase, logger)
	...
	t.Run("Create request", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodPost, "/api/documents", bytes.NewBuffer(body))
		...
		mockUseCase.EXPECT().Create(gomock.Any()).Return(expectedDocument, nil)
	...
	t.Run("Create request bad body", func(t *testing.T) {
		badDocument := &models.DocumentCreate{
			Title:       "bad",
			Description: "description",
		}

		body, err := json.Marshal(badDocument)
		if err != nil {
			t.Fatalf("Failed to marshal JSON: %v", err)
		}
...
func TestGetById(t *testing.T) {
	...
	t.Run("Get by id request", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodGet, "/api/documents/"+strconv.Itoa(int(document.ID)), nil)
		res := httptest.NewRecorder()
		ctx, _ := gin.CreateTestContext(res)
		ctx.Params = gin.Params{{Key: "id", Value: strconv.Itoa(int(document.ID))}}
		ctx.Request = req

		mockUseCase.EXPECT().GetById(document.ID).Return(document, nil)
	...
	t.Run("Get by id request wrong url param", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodGet, "/api/documents/badParam", nil)
		res := httptest.NewRecorder()
		ctx, _ := gin.CreateTestContext(res)
	...
	t.Run("Get by id request not found", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodGet, "/api/documents/10", nil)
		res := httptest.NewRecorder()
		ctx, _ := gin.CreateTestContext(res)
...
func TestGetAll(t *testing.T) {
	...
	t.Run("Get all request", func(t *testing.T) {
		...
		mockUseCase.EXPECT().GetAll().Return(documents, nil)
...
func TestUpdate(t *testing.T) {
	...
	document := &models.DocumentUpdate{
		Title:       "longtitle",
		Description: "description",
	}
	...
	t.Run("Update request", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodPut, "/api/documents/1", bytes.NewBuffer(body))
		req.Header.Set("Content-type", "application/json")
		res := httptest.NewRecorder()
		ctx, _ := gin.CreateTestContext(res)
		...
		mockUseCase.EXPECT().Update(uint(1), gomock.Any()).Return(expectedDocument, nil)
	...
	t.Run("Update request wrong url param", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodPut, "/api/documents/badParam", nil)
		res := httptest.NewRecorder()
		ctx, _ := gin.CreateTestContext(res)
		ctx.Params = gin.Params{{Key: "id", Value: "badParam"}}
		ctx.Request = req
	...
	t.Run("Update request bad body", func(t *testing.T) {
		badDocument := &models.DocumentUpdate{
			Title:       "bad",
			Description: "description",
		}
...
func TestDelete(t *testing.T) {
	...
	t.Run("Delete request wrong url param", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodDelete, "/api/documents/badParam", nil)
		res := httptest.NewRecorder()
		ctx, _ := gin.CreateTestContext(res)
		ctx.Params = gin.Params{{Key: "id", Value: "badParam"}}
		ctx.Request = req
	...
	t.Run("Delete request not found", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodDelete, "/api/documents/10", nil)
		res := httptest.NewRecorder()
		ctx, _ := gin.CreateTestContext(res)
		ctx.Params = gin.Params{{Key: "id", Value: "10"}}
		ctx.Request = req
