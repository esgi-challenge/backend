...
func TestCreate(t *testing.T) {
	...
	handlers := NewInformationsHandlers(nil, mockUseCase, logger)

	informations := &models.InformationsCreate{
		Title:       "longtitle",
		Description: "description",
	}

	body, err := json.Marshal(informations)
	if err != nil {
		t.Fatalf("Failed to marshal JSON: %v", err)
	}

	t.Run("Create request", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodPost, "/api/informationss", bytes.NewBuffer(body))
		req.Header.Set("Content-type", "application/json")
		res := httptest.NewRecorder()
		ctx, _ := gin.CreateTestContext(res)
		ctx.Request = req

		expectedInformations := &models.Informations{
			Title:       "title",
			Description: "description",
		}
		mockUseCase.EXPECT().Create(gomock.Any()).Return(expectedInformations, nil)
	...
	t.Run("Create request bad body", func(t *testing.T) {
		badInformations := &models.InformationsCreate{
			Title:       "bad",
			Description: "description",
		}

		body, err := json.Marshal(badInformations)
		if err != nil {
			t.Fatalf("Failed to marshal JSON: %v", err)
		}
...
func TestGetById(t *testing.T) {
	...
	t.Run("Get by id request", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodGet, "/api/informationss/"+strconv.Itoa(int(informations.ID)), nil)
		res := httptest.NewRecorder()
		ctx, _ := gin.CreateTestContext(res)
		ctx.Params = gin.Params{{Key: "id", Value: strconv.Itoa(int(informations.ID))}}
		ctx.Request = req

		mockUseCase.EXPECT().GetById(informations.ID).Return(informations, nil)
	...
	t.Run("Get by id request wrong url param", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodGet, "/api/informationss/badParam", nil)
		res := httptest.NewRecorder()
		ctx, _ := gin.CreateTestContext(res)
	...
	t.Run("Get by id request not found", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodGet, "/api/informationss/10", nil)
		res := httptest.NewRecorder()
		ctx, _ := gin.CreateTestContext(res)
...
func TestGetAll(t *testing.T) {
	...
	t.Run("Get all request", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodGet, "/api/informationss", nil)
		res := httptest.NewRecorder()
		ctx, _ := gin.CreateTestContext(res)
		ctx.Request = req

		mockUseCase.EXPECT().GetAll().Return(informationss, nil)
...
func TestUpdate(t *testing.T) {
	...
	informations := &models.InformationsUpdate{
		Title:       "longtitle",
		Description: "description",
	}
	...
	t.Run("Update request", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodPut, "/api/informationss/1", bytes.NewBuffer(body))
		req.Header.Set("Content-type", "application/json")
		res := httptest.NewRecorder()
		ctx, _ := gin.CreateTestContext(res)
		...
		mockUseCase.EXPECT().Update(uint(1), gomock.Any()).Return(expectedInformations, nil)
	...
	t.Run("Update request wrong url param", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodPut, "/api/informationss/badParam", nil)
		res := httptest.NewRecorder()
		ctx, _ := gin.CreateTestContext(res)
		ctx.Params = gin.Params{{Key: "id", Value: "badParam"}}
		ctx.Request = req
	...
	t.Run("Update request bad body", func(t *testing.T) {
		badInformations := &models.InformationsUpdate{
			Title:       "bad",
			Description: "description",
		}
...
func TestDelete(t *testing.T) {
	...
	t.Run("Delete request", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodDelete, "/api/informationss/1", nil)
		res := httptest.NewRecorder()
		ctx, _ := gin.CreateTestContext(res)
		ctx.Params = gin.Params{{Key: "id", Value: "1"}}
		ctx.Request = req
	...
	t.Run("Delete request wrong url param", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodDelete, "/api/informationss/badParam", nil)
		res := httptest.NewRecorder()
		ctx, _ := gin.CreateTestContext(res)
		ctx.Params = gin.Params{{Key: "id", Value: "badParam"}}
		ctx.Request = req
	...
	t.Run("Delete request not found", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodDelete, "/api/informationss/10", nil)
		res := httptest.NewRecorder()
		ctx, _ := gin.CreateTestContext(res)
		ctx.Params = gin.Params{{Key: "id", Value: "10"}}
		ctx.Request = req
